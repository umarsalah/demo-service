...
export const downloadFileFromBucket = async (
    ...
    try {
        if (!downloadToPath || !bucketName || !filePathInBucket) {
            ...
            return { ok: false, error: new Error('downloadToPath,bucketName and filePathInBucket are required') };
        } else {
...
export const uploadFileToBucket = async (
    ...
    try {
        if (!localPath || !bucketName || !filePathInBucket) {
            ...
            return { ok: false, error: new Error('localPath,bucketName and filePathInBucket are required') };
        } else {
